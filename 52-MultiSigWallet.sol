...
contract MultiSigWallet {
    ...
    constructor(address[] memory _owner, uint256 _required) {
        require(_owner.length > 0, "owners requires");
        require(
        ...
        for (uint256 i; i < _owner.length; i++) {
            ...
            require(owner != address(0), "invalid owener");
    ...
    function execute(uint256 _txId) external txExists(_txId) {
